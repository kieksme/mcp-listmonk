...
## [1.4.0](https://github.com/kieksme/mcp-listmonk/compare/listmonk-mcp-v1.3.0...listmonk-mcp-v1.4.0) (2026-09-14)


### Features

* **config:** add cross-client MCP configurations ([c5089bc](https://github.com/kieksme/mcp-listmonk/commit/c5089bce8f0cbe4d30ada5cad518f0409d632627))
* **config:** add cross-client MCP configurations ([5e18abc](https://github.com/kieksme/mcp-listmonk/commit/5e18abcdd6fcfa586bc75f3919263790c5cd07d2))
